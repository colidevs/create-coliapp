 ...
 */
import type { OrderOutputBuyerInfo } from "./orderOutputBuyerInfo";
import type { OrderOutputBuyerProductsItem } from "./orderOutputBuyerProductsItem";
...
export interface OrderOutput {
	...
	orderId: string;
	mail: string | null;
	buyerInfo: OrderOutputBuyerInfo;
	dlocalId: string | null;
	buyerProducts: OrderOutputBuyerProductsItem[];
	status: string;
